...
BEGIN_EVENT_TABLE(DrawFrame, wxFrame)
    ...
    EVT_MENU(XRCID("MoveCursorEnd"), DrawFrame::OnGoToLatestDate)
    ...
    LOG_EVT_MENU(drawTB_EXIT, DrawFrame , OnExit )
    LOG_EVT_MENU(drawTB_ABOUT, DrawFrame , OnAbout )
    LOG_EVT_MENU(drawTB_REMARK, DrawFrame , OnShowRemarks)
    LOG_EVT_MENU(drawTB_FLORENCE, DrawFrame , OnShowKeyboard)
    LOG_EVT_MENU(drawTB_GOTOLATESTDATE, DrawFrame , OnGoToLatestDate)
    LOG_EVT_MENU(XRCID("GoToLatestDate"), DrawFrame , OnGoToLatestDate)
    LOG_EVT_MENU(XRCID("SearchDate"), DrawFrame , OnSearchDate )
