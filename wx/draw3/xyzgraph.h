...
class XYZFrame: public XFrame, public szFrame {
	...
	XYDialog *m_xydialog;
public:
	XYZFrame(wxString default_prefix, DatabaseManager *dbmanager, ConfigManager *cfgmanager, TimeInfo time, std::vector<DrawInfo*> user_draws, FrameManager *frame_manager);
