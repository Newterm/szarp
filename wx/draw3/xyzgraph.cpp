...
BEGIN_EVENT_TABLE(XYZCanvas, wxGLCanvas)
	...
	LOG_EVT_KEY_UP(XYZCanvas , OnKeyUp, "xyzgraph:keyup" )
	LOG_EVT_CHAR(XYZCanvas , OnChar, "xyzgraph:char" )
	LOG_EVT_LEFT_DOWN(XYZCanvas , OnMouseLeftDown, "xyzgraph:left_down" )
	LOG_EVT_RIGHT_DOWN(XYZCanvas , OnMouseRightDown, "xyzgraph:right_down" )
	LOG_EVT_RIGHT_UP(XYZCanvas , OnMouseRightUp, "xyzgraph:right_up" )
	...
	LOG_EVT_MOUSEWHEEL(XYZCanvas , OnMouseWheel, "xyzgraph:wheel" )
END_EVENT_TABLE()
...
BEGIN_EVENT_TABLE(XYZFrame, szFrame)
	LOG_EVT_MENU(XYZ_CHANGE_GRAPH, XYZFrame , OnChangeGraph, "xyzgraph:change_graph" )
	LOG_EVT_MENU(XYZ_PRINT, XYZFrame , OnPrint, "xyzgraph:print" )
	LOG_EVT_MENU(XYZ_PRINT_PREVIEW, XYZFrame , OnPrintPreview, "xyzgraph:print_preview" )
	LOG_EVT_MENU(XYZ_PRINT_PAGE_SETUP, XYZFrame , OnPageSetup, "xyzgraph:print_page_setup" )
	LOG_EVT_MENU(wxID_EXIT, XYZFrame , OnQuit, "xyzgraph:exit" )
	LOG_EVT_MENU(wxID_HELP, XYZFrame , OnHelp, "xyzgraph:help" )
END_EVENT_TABLE()
