...
BEGIN_EVENT_TABLE (CodeEditor, wxScintilla)
    ...
    LOG_EVT_MENU (wxID_CLEAR,              CodeEditor , OnEditClear, "codeedit:clear" )
    LOG_EVT_MENU (wxID_CUT,                CodeEditor , OnEditCut, "codeedit:cut" )
    LOG_EVT_MENU (wxID_COPY,               CodeEditor , OnEditCopy, "codeedit:copy" )
    LOG_EVT_MENU (wxID_PASTE,              CodeEditor , OnEditPaste, "codeedit:paste" )
    LOG_EVT_MENU (codeEditorID_INDENTINC,          CodeEditor , OnEditIndentInc, "codeedit:indentinc" )
    LOG_EVT_MENU (codeEditorID_INDENTRED,          CodeEditor , OnEditIndentRed, "codeedit:indentred" )
    LOG_EVT_MENU (wxID_SELECTALL,          CodeEditor , OnEditSelectAll, "codeedit:selectall" )
    ...
    LOG_EVT_MENU (codeEditorID_WHITESPACE,         CodeEditor , OnWhiteSpace, "codeedit:whitespace" )
    LOG_EVT_MENU (codeEditorID_FOLDTOGGLE,         CodeEditor , OnFoldToggle, "codeedit:foldtoggle" )
