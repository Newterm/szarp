...
BEGIN_EVENT_TABLE(StatDialog, szFrame) 
	EVT_BUTTON(STAT_START_TIME, StatDialog::OnDateChange)
	EVT_BUTTON(STAT_END_TIME, StatDialog::OnDateChange)
	EVT_BUTTON(STAT_DRAW_BUTTON, StatDialog::OnDrawChange)
	EVT_BUTTON(wxID_OK, StatDialog::OnCalculate)
	EVT_BUTTON(wxID_CLOSE, StatDialog::OnCloseButton)
	EVT_BUTTON(wxID_HELP, StatDialog::OnHelpButton)
	EVT_SHOW(StatDialog::OnShow)
	EVT_CHOICE(STAT_CHOICE_PERIOD, StatDialog::OnPeriodChange)
	EVT_CLOSE(StatDialog::OnClose)
END_EVENT_TABLE()
