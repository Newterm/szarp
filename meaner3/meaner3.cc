...
const char *argp_program_version = "meaner 3.""$Revision: 4393 $";
...
These options are mandatory:\n\
	...
	base_format	type of base format used, to run meaner3 must be set\n\
			to 'szarpbase'.\n\
