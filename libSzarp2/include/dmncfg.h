...
public:
	 ...
	 * @param sz_cfg pointer to szarp configuration. If NULL, configuration is read from file
	 *
	 ...
	 */
	virtual int Load(int *argc, char **argv, int libpardone = 1 , TSzarpConfig* sz_cfg = NULL );
...
protected:
	 ...
	 * 
	 * @param previously loaded szarp configuration
	 * 
	 * @return 0 on success and 1 on error
	 */
	int LoadNotXML( TSzarpConfig* cfg );
