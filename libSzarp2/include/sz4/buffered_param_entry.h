...
template<class value_type, class time_type, class types, template<class types2> class calculation_method> class buffered_param_entry_in_buffer : public SzbParamObserver {
protected:
