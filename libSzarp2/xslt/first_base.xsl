...
<!--
	...
	$Id: first_base.xsl 4393 2007-09-13 16:37:10Z reksio $

	Ten szablon wypisuje wartość atrybuty 'base_ind' pierwszego z
	wszystkich elementów 'param' z dokumentu.
...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="/">
		<xsl:value-of select=".//ipk:param[position()=1]/@base_ind"/>
	</xsl:template>
